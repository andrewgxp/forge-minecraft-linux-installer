...
configure-headless-start() {
    ...
    sed -i 's#java @user_jvm_args.txt @libraries/net/minecraftforge/forge/[^/]*/unix_args.txt "$@"#java @user_jvm_args.txt @libraries/net/minecraftforge/forge/\1/unix_args.txt -nogui "$@"#' run.sh
}
